...
function Set-Gpup {
    param (
        ...
        [string]$DisplayType = "nvidia" #nvidia, amd
    )

    $drivers = ""
    if ($DisplayType -eq "nvidia") {
        ...
        'Windows\system32\NvIFROpenGL.dll',
        'Windows\system32\nvinfo.pb',
        'Windows\system32\nvml.dll',
        'Windows\system32\nvofapi64.dll',
        'Windows\SysWOW64\nvapi64.dll',
        ...
        'Windows\SysWOW64\NvIFROpenGL.dll',
        'Windows\SysWOW64\nvofapi.dll',
        'Windows\System32\DriverStore\FileRepository\nvmdi.inf_amd64_799504293a3d3200\') # this one may change, can pull via sep. cmd
    } else {
        ...
        'Windows\System32\DriverStore\FileRepository\u0358464.inf_amd64_7acaccafba92993d\') # this one may change, can pull via sep. cmd
    }
